...
Defined in: [Hotspot/Hotspots.ts:16](https://github.com/thib3113/unifi-client/blob/a5b15ed/src/Hotspot/Hotspots.ts#L16)
...
▸ `Protected`**import**(`props`: *any*): [*default*](hotspot_hotspots.default.md)
...
Defined in: [Hotspot/Hotspots.ts:55](https://github.com/thib3113/unifi-client/blob/a5b15ed/src/Hotspot/Hotspots.ts#L55)
