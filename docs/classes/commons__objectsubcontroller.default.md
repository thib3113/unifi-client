[unifi-client - v0.0.23](../README.md) / [Exports](../modules.md) / [commons/_ObjectSubController](../modules/commons__objectsubcontroller.md) / default
...
Defined in: [commons/_ObjectSubController.ts:43](https://github.com/thib3113/unifi-client/blob/3b1db86/src/commons/_ObjectSubController.ts#L43)
