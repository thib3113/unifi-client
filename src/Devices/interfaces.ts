import { ipV4Address, ipv4CIDR, macAddress, netMask } from '../commons/types';
...
export interface IEthernetOverride {
    ifname: string;
    networkgroup: EConnectionNetworkName;
}
...
export interface INetworkTable {
    ...
    attr_hidden_id?: EConnectionNetworkName;
    name: string;
    site_id: string;
    ...
    nat_outbound_ip_addresses?: Array<any>;
    dhcpd_dns_3?: string;
    is_guest: boolean;
    ip: string;
    mac: string;
...
export interface IPortOverride {
    ...
    portconf_id?: string;
    op_mode?: EOpMode;
    port_security_mac_address?: Array<any>;
...
export interface IPortTable {
    ...
    dns?: Array<string>;
    poe_caps?: number;
    dot1x_mode?: EDot1XMode;
    dot1x_status?: EDot1XStatus;
    jumbo?: boolean;
    satisfaction?: number;
    satisfaction_reason?: number;
    stp_pathcost?: number;
    stp_state?: EDot1XStatus;
    poe_mode?: string;
    poe_enable?: boolean;
    poe_voltage?: string;
    aggregate_num_ports?: number;
...
export interface ISw {
    ...
    'port_11-rx_packets'?: number;
    'port_11-rx_bytes'?: number;
    'port_11-tx_packets'?: number;
    'port_11-tx_bytes'?: number;
    'port_4-rx_packets'?: number;
    'port_4-rx_bytes'?: number;
    'port_4-tx_packets'?: number;
    'port_4-tx_bytes'?: number;
    'port_4-rx_multicast'?: number;
    'port_4-rx_broadcast'?: number;
    'port_4-tx_multicast'?: number;
    'port_4-tx_broadcast'?: number;
    'port_2-rx_packets'?: number;
    'port_2-rx_bytes'?: number;
    'port_2-tx_packets'?: number;
    'port_2-tx_bytes'?: number;
    'port_2-rx_multicast'?: number;
    'port_2-rx_broadcast'?: number;
    'port_2-tx_multicast'?: number;
    'port_3-rx_packets'?: number;
    'port_3-rx_bytes'?: number;
    'port_3-tx_packets'?: number;
    'port_3-tx_bytes'?: number;
    'port_3-rx_multicast'?: number;
    'port_3-rx_broadcast'?: number;
    'port_3-tx_multicast'?: number;
    'port_5-rx_packets'?: number;
    'port_5-rx_bytes'?: number;
    'port_5-tx_packets'?: number;
    'port_5-tx_bytes'?: number;
    'port_5-rx_multicast'?: number;
    'port_5-rx_broadcast'?: number;
    'port_5-tx_multicast'?: number;
    'port_6-rx_packets'?: number;
    'port_6-rx_bytes'?: number;
    'port_6-tx_packets'?: number;
    'port_6-tx_bytes'?: number;
    'port_6-rx_multicast'?: number;
    'port_6-tx_multicast'?: number;
    'port_13-rx_packets'?: number;
    'port_13-rx_bytes'?: number;
    'port_13-tx_packets'?: number;
    'port_13-tx_bytes'?: number;
    'port_13-rx_multicast'?: number;
    'port_13-rx_broadcast'?: number;
    'port_13-tx_multicast'?: number;
    'port_13-tx_broadcast'?: number;
    'port_15-rx_packets'?: number;
    'port_15-rx_bytes'?: number;
    'port_15-tx_packets'?: number;
    'port_15-tx_bytes'?: number;
    'port_15-rx_multicast'?: number;
    'port_15-rx_broadcast'?: number;
    'port_15-tx_multicast'?: number;
    'port_15-tx_broadcast'?: number;
    'port_17-rx_packets'?: number;
    'port_17-rx_bytes'?: number;
    'port_17-tx_packets'?: number;
    'port_17-tx_bytes'?: number;
    'port_17-rx_multicast'?: number;
    'port_17-rx_broadcast'?: number;
    'port_17-tx_multicast'?: number;
    'port_17-tx_broadcast'?: number;
    'port_19-rx_packets'?: number;
    'port_19-rx_bytes'?: number;
    'port_19-tx_packets'?: number;
    'port_19-tx_bytes'?: number;
    'port_19-rx_multicast'?: number;
    'port_19-rx_broadcast'?: number;
    'port_19-tx_multicast'?: number;
    'port_19-tx_broadcast'?: number;
    'port_23-rx_packets'?: number;
    'port_23-rx_bytes'?: number;
    'port_23-tx_packets'?: number;
    'port_23-tx_bytes'?: number;
    'port_23-rx_multicast'?: number;
    'port_23-rx_broadcast'?: number;
    'port_23-tx_multicast'?: number;
    'port_23-tx_broadcast'?: number;
    'port_24-rx_packets'?: number;
    'port_24-rx_bytes'?: number;
    'port_24-tx_packets'?: number;
    'port_24-tx_bytes'?: number;
    'port_24-rx_multicast'?: number;
    'port_24-tx_multicast'?: number;
    'port_24-tx_broadcast'?: number;
    'port_26-rx_packets'?: number;
    'port_26-rx_bytes'?: number;
    'port_26-tx_packets'?: number;
    'port_26-tx_bytes'?: number;
    'port_26-rx_multicast'?: number;
    'port_26-rx_broadcast'?: number;
    'port_26-tx_multicast'?: number;
    'port_26-tx_broadcast'?: number;
    'port_2-tx_broadcast'?: number;
    'port_3-tx_broadcast'?: number;
    'port_5-tx_broadcast'?: number;
    'port_6-tx_broadcast'?: number;
    'port_13-tx_dropped'?: number;
    'port_1-tx_dropped'?: number;
    'port_11-rx_multicast'?: number;
    'port_11-rx_broadcast'?: number;
    'port_11-tx_multicast'?: number;
    'port_11-tx_broadcast'?: number;
    'port_11-tx_dropped'?: number;
    'port_9-rx_packets'?: number;
    'port_9-rx_bytes'?: number;
    'port_9-tx_packets'?: number;
    'port_9-tx_bytes'?: number;
    'port_9-rx_multicast'?: number;
    'port_9-rx_broadcast'?: number;
    'port_9-tx_multicast'?: number;
    'port_9-tx_broadcast'?: number;
    'port_10-rx_packets'?: number;
    'port_10-rx_bytes'?: number;
    'port_10-tx_packets'?: number;
    'port_10-tx_bytes'?: number;
    'port_10-rx_multicast'?: number;
    'port_10-rx_broadcast'?: number;
    'port_10-tx_multicast'?: number;
    'port_10-tx_broadcast'?: number;
    'port_6-rx_broadcast'?: number;
    'port_7-rx_packets'?: number;
    'port_7-rx_bytes'?: number;
    'port_7-tx_packets'?: number;
    'port_7-tx_bytes'?: number;
    'port_7-rx_multicast'?: number;
    'port_7-rx_broadcast'?: number;
    'port_7-tx_multicast'?: number;
    'port_7-tx_broadcast'?: number;
    'port_8-tx_packets'?: number;
    'port_8-tx_bytes'?: number;
    'port_8-tx_multicast'?: number;
    'port_8-tx_broadcast'?: number;
    'port_8-rx_packets'?: number;
    'port_8-rx_bytes'?: number;
    'port_8-rx_multicast'?: number;
    'port_8-rx_broadcast'?: number;
}
...
export interface IVwireVapTable {
    state: EState;
    radio: ERadio;
    radio_name: string;
    bssid: string;
